...
## Below code opens PNG file device with filename as "plot1.png"
png(filename="plot1.png", width=480, height=480)
## Below code plots histogram 
hist(DT_new$Global_active_power, main="Global Active Power", xlab="Global Active Power (kilowatts)", col="red")
